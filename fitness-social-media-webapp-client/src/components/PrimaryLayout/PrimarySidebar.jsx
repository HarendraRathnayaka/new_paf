    ...
    <>
      <div className="flex w-screen h-screen text-gray-700">
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-grow p-4 overflow-auto home-menu">
            {menus.map((menu, index) => (
              <NavLink
                key={index}
                className="flex my-1 items-center flex-shrink-0 h-10 px-2 pl-3 text-sm font-medium rounded-xl hover:bg-gray-300 hover:text-black transition-all"
                to={menu.link}
              >
        ...
        <div className="flex flex-col flex-grow">
          <div className="flex-grow p-6 overflow-auto bg-gray-100 pl-24">
            {children}
